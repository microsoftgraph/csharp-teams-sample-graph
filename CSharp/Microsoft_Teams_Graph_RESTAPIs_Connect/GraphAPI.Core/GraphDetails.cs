...
namespace GraphAPI.Core
{
    public class GraphDetails : IGraphDetails
    {
        /// <summary>
        /// Create new channel.
        /// </summary>
        ...
        {
            string endpoint = Utility.GraphRootUri + "groups/" + teamId + "/channels";
            ...
            HttpResponseMessage response = await Utility.SendRequest(HttpMethod.Get, endpoint, accessToken, content);
        ...
        public async Task<IEnumerable<ResultsItem>> GetChannels(string accessToken, string teamId, string resourcePropId)
        {
            ...
            HttpResponseMessage response = await Utility.SendRequest(HttpMethod.Get, endpoint, accessToken);
            if (response != null && response.IsSuccessStatusCode)
            {
                items = await Utility.GetResultsItem(response, idPropertyName, displayPropertyName, resourcePropId);
        ...
        public async Task<string> GetMyId(String accessToken)
        {
            ...
            String userId = "";
            HttpResponseMessage response = await Utility.SendRequest(HttpMethod.Get, endpoint + queryParameter, accessToken);
            if (response != null && response.IsSuccessStatusCode)
            {
        ...
        public async Task<IEnumerable<ResultsItem>> GetMyTeams(string accessToken, string resourcePropId)
        {
            ...
            string endpoint = Utility.GraphRootUri + "me/joinedTeams";
            string idPropertyName = "id";
            string displayPropertyName = "displayName";
        ...
        {
            string endpoint = Utility.GraphRootUri + "groups/" + teamId + "/channels/" + channelId + "/chatThreads";
